...
void modelModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_ConvolutionPoolAct_SQ8("S4_Conv2d_128x64x3x3_MaxPool_2x2_Relu", 0, 4, 1, 64, 128, 39, 29,
        KOP_CONV, 3, 3, 1, 1, 1, 1, 0,
        KOP_MAXPOOL, 2, 2, 1, 1, 2, 2, 0,
        KOP_RELU);
    // generator for FULLY_CONNECTED_0_6
    CNN_LinearAct_SQ8("S5_Linear_64x13x18x128", 0, 4, 1, 29952, 64, KOP_LINEAR, KOP_NONE);
    // generator for FULLY_CONNECTED_0_7
    CNN_LinearAct_SQ8("S6_Linear_2x64", 0, 4, 1, 64, 2, KOP_LINEAR, KOP_NONE);
    // generator for SOFTMAX_0_8
    CNN_SoftMax_SQ8("S7_SoftMax", 0, 2, KOP_SOFTMAX);
...
#define GRAPH
    ...
    CreateGraph("modelCNN",
        /* Arguments either passed or globals */
            CArgs(28,
                ...
                TCArgInfo("signed char * __restrict__", "S5_Weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S5_Weights.tensor", 1, 1, 1, 0)),
                TCArgInfo("signed int * __restrict__", "S5_Biases", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S5_Biases.tensor", 1, 1, 4, 0)),
                TCArgInfo("unsigned char * __restrict__", "S5_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S5_Mul_scale.tensor", 1, 1, 1, 0)),
                TCArgInfo("signed char * __restrict__", "S5_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S5_Mul_shift.tensor", 1, 1, 1, 0)),
                // BiasQ: 0
                TCArgInfo("signed char * __restrict__", "S6_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S6_Infos.tensor", 1, 1, 1, 0)),
                TCArgInfo("signed char * __restrict__", "S6_Weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S6_Weights.tensor", 1, 1, 1, 0)),
                TCArgInfo("signed int * __restrict__", "S6_Biases", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S6_Biases.tensor", 1, 1, 4, 0)),
                TCArgInfo("unsigned char * __restrict__", "S6_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S6_Mul_scale.tensor", 1, 1, 1, 0)),
                TCArgInfo("signed char * __restrict__", "S6_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S6_Mul_shift.tensor", 1, 1, 1, 0)),
                // in: 0.125000 out: 0.000031 NORM: 12
                TCArgInfo("signed char * __restrict__", "S7_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SQ8BIT/tensors/S7_Infos.tensor", 1, 1, 1, 0)),
    ...
    // Node S2_Conv2d_32x1x3x3_MaxPool_2x2_Relu inq -1.00<i8*0.00781250<0.99 weightsq chan<i8*chan<chan outq -0.68<i8*0.00527614<0.67 biasesq i32*chan
    ...
    // Node S3_Conv2d_64x32x3x3_MaxPool_2x2_Relu inq -0.68<i8*0.00527614<0.67 weightsq chan<i8*chan<chan outq -0.54<i8*0.00419040<0.53 biasesq i32*chan
    ...
    // Node S4_Conv2d_128x64x3x3_MaxPool_2x2_Relu inq -0.54<i8*0.00419040<0.53 weightsq chan<i8*chan<chan outq -0.90<i8*0.00706601<0.90 biasesq i32*chan
    AddNode("S4_Conv2d_128x64x3x3_MaxPool_2x2_Relu", Bindings(7, GNodeArg(GNA_IN, "S3_Output", 0), GNodeArg(GNA_IN, "S4_Weights", 0), GNodeArg(GNA_IN, "S4_Biases", 0), GNodeArg(GNA_OUT, "S4_Output", 0), GNodeArg(GNA_IN, "S4_Mul_scale", 0), GNodeArg(GNA_IN, "S4_Mul_shift", 0), GNodeArg(GNA_IN, "S4_Infos", 0)));
    // Node FULLY_CONNECTED_0_6 inq -0.90<i8*0.00706601<0.90 weightsq chan<i8*chan<chan outq -2.16<i8*0.01687440<2.14
    AddNode("S5_Linear_64x13x18x128", Bindings(7, GNodeArg(GNA_IN, "S4_Output", 0), GNodeArg(GNA_IN, "S5_Weights", 0), GNodeArg(GNA_IN, "S5_Biases", 0), GNodeArg(GNA_OUT, "S5_Output", 0), GNodeArg(GNA_IN, "S5_Mul_scale", 0), GNodeArg(GNA_IN, "S5_Mul_shift", 0), GNodeArg(GNA_IN, "S5_Infos", 0)));
    // Node FULLY_CONNECTED_0_7 inq -2.16<i8*0.01687440<2.14 weightsq chan<i8*chan<chan outq -9.24<i8*0.12500000<9.17
    AddNode("S6_Linear_2x64", Bindings(7, GNodeArg(GNA_IN, "S5_Output", 0), GNodeArg(GNA_IN, "S6_Weights", 0), GNodeArg(GNA_IN, "S6_Biases", 0), GNodeArg(GNA_OUT, "S6_Output", 0), GNodeArg(GNA_IN, "S6_Mul_scale", 0), GNodeArg(GNA_IN, "S6_Mul_shift", 0), GNodeArg(GNA_IN, "S6_Infos", 0)));
    // Node SOFTMAX_0_8 inq 3 outq 15
    AddNode("S7_SoftMax", Bindings(3, GNodeArg(GNA_IN, "S6_Output", 0), GNodeArg(GNA_OUT, "Output_1", 0), GNodeArg(GNA_IN, "S7_Infos", 0)));
    CloseGraph();
#endif
}
